    ...
    return <>
        <div className=" w-full mx-auto">
            ...
            <Carousel
                ...
                className="container mx-auto w-3/4"
            >
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="mt-5 text-3xl font-semibold">Popular category</h1>
                        <p className="mt-3 mb-5 text-xl">2020 jobs live – 293 added today.</p>
                    </div>
                    <a className="text-green-700 text-xl" href="">view all categories</a>
                </div>
                <CarouselContent>
                ...
                <CarouselPrevious className="hover:bg-green-700 p-2" />
                <CarouselNext className="hover:bg-green-700 p-2" />
            </Carousel >
        </div >
    </>
}
